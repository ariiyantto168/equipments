    ...
    public function excel(Request $request)
    {
      if ($request->has('date') || $request->has('type') || $request->has('action_by') ) {
        ...
        foreach ($works as $work) {
          ...
          $img_before = $img_after = NULL ;
          if ($work->image_before != NULL || $work->image_after != NULL) {
            $image_before = env('CDN_URL').'workplan_image/'.$work->image_before;
            $image_after = env('CDN_URL').'workplan_image/'.$work->image_before;
          }
