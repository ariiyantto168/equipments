    ...
    <div class="box-body">
      <table class="table ">
        <tr>
          ...
          <td>:
            @if (isset($approvals->equipment_details->equipments))
              {{$approvals->equipment_details->equipments->description}}
            @endif
          </td>
        </tr>
        <tr>
          <td><b>Location</b></td>
          <td>
            @if (!is_null($approvals->equipment_details->funloc_details))
            :{{$approvals->equipment_details->funloc_details->description}}
            @else
            :  -
            @endif
            </td>
        ...
        <tr>
          ...
          <td>
            @if (!is_null($approvals->equipment_details->funloc_details))
              : {{$approvals->equipment_details->funloc_details->levels->name}}
            @else
              : -
            @endif
          </td>
